          ...
          <table class="table table-striped" style="max-width:1080px;">
            ...
            <tbody>
              <tr>
                ...
                <td><a href="./boardView.html" style="color:#000000;">어벤져스:인피니티 워</a></td>
                <td style="text-align: center;">149분</td>
                <td style="text-align: center;">2018-04-25</td>
                <td onclick="location.href = './reservation.html';" class="btn btn-primary float-right">상영관</td>
              </tr>
              <tr>
                <td style="text-align: center;">미스터리</td>
                <td><a href="./boardView.html" style="color:#000000;">버닝</a></td>
              ...
              <tr>
                <td style="text-align: center;">액션/모험</td>
                <td><a href="./boardView.html" style="color:#000000;">데드풀2</a></td>
              ...
              <tr>
                ...
                <td><a href="./boardView.html" style="color:#000000;">레슬러</a></td>
              ...
              <tr>
                ...
                <td><a href="./boardView.html" style="color:#000000;">안녕, 나의 소녀</a></td>
